...
export default function AdminProfileScreen() {
  ...
  const [profileData, setProfileData] = useState({
    firstName: currentUser?.firstName || 'Juan',
    lastName: currentUser?.lastName || 'Dela Cruz',
    email: currentUser?.email || 'juan.delacruz@university.edu',
    ...
    officeLocation: currentUser?.officeLocation || 'Room 101, Admin Building',
