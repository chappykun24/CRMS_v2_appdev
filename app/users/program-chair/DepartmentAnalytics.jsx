...
export default function AnalyticsDashboard() {
  ...
  const checkCachedAnalytics = async () => {
    ...
    try {
      const response = await apiClient.get(`/analytics/cache/program-chair/${currentUser.user_id}`);
      return response;
    } catch (error) {
  ...
  const storeAnalyticsInCache = async (analyticsData) => {
    ...
    try {
      await apiClient.post(`/analytics/cache/program-chair/${currentUser.user_id}`, {
  ...
  const refreshAnalytics = async () => {
    ...
    try {
      ...
      try {
        await apiClient.delete(`/analytics/cache/program-chair/${currentUser.user_id}`);
      } catch (cacheError) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Program Chair Analytics Dashboard</Text>
