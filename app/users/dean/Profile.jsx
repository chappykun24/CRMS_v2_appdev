...
export default function DeanProfileScreen() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: currentUser?.email || 'maria.santos@university.edu',
    phone: currentUser?.phone || '+63 912 345 6789',
    position: currentUser?.position || 'Dean, College of Engineering',
    department: currentUser?.department || 'Engineering',
    officeLocation: currentUser?.officeLocation || 'Room 301, Engineering Building',
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.profilePictureSection}>
          ...
          <Text style={styles.profileRole}>Dean</Text>
