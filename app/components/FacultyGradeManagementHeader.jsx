...
export default function FacultyGradeManagementHeader({ 
  currentView,
  selectedClass,
  selectedAssessment,
  searchQuery,
  ...
  showSearch,
  setShowSearch,
  showAssessmentSearch,
  setShowAssessmentSearch,
  showStudentSearch,
  ...
  const getTitle = () => {
    if (currentView === 'classes') return 'Grade Management';
    if (currentView === 'classDetails') return `${selectedClass?.courseCode} - Grade Management`;
  ...
  const renderSearchBar = () => {
    ...
    if (currentView === 'classDetails' && showAssessmentSearch) {
      return (
        <View style={styles.searchContainer}>
          <View style={styles.searchInputContainer}>
            <Ionicons name="search" size={20} color="#9CA3AF" style={styles.searchIcon} />
    ...
    if (currentView === 'assessmentDetails' && showStudentSearch) {
      return (
        <View style={styles.searchContainer}>
          <View style={styles.searchInputContainer}>
            <Ionicons name="search" size={20} color="#9CA3AF" style={styles.searchIcon} />
      ...
      <View style={styles.headerContent}>
        ...
        <View style={styles.headerButtons}>
          ...
          {currentView === 'classDetails' && (
            <TouchableOpacity style={styles.toggleButton} onPress={() => setShowAssessmentSearch((prev) => !prev)}>
              <Ionicons name={showAssessmentSearch ? 'close-outline' : 'search-outline'} size={20} color="#dc2626" />
            </TouchableOpacity>
          )}
